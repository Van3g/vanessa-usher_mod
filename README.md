...
Что умеет yard:
ярд на базе ашера умеет только выкачивать релиз и раскладывать его в гит, потом пушить в гит
Кейс про синхронизация конфигурации вендора
Мы так ЕРП собираем и через сонаркуб прогоняем
